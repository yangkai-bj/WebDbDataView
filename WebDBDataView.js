...
function getImageBase64Code() {
    ...
    source.onchange = function() {
        ...
        reader.onload = function (e) {
            ...
            image.onload = function () {
                ...
                let size = getSize(800, 600, this.width, this.height);
                this.width = size[0];
                this.height = size[1];
                this.style.margin = "auto";
                this.style.display = "block";
                this.style.padding = (600 - size[1])/2 + "px 0";
            };
            $("edit-container").appendChild(image);
        };
    };
    ...
    filecontainer.style.height = "600px";
...
function getFileSecurity() {
    ...
    function fileDecrypt(data, key) {
        ...
        try {
            ...
            infors.push({"commit": false, "error": e});
        }
        return infors;
    }
